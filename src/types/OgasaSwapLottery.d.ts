...
interface OgasaSwapLotteryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "maxPriceTicketInOgasa()": FunctionFragment;
    "minPriceTicketInOgasa()": FunctionFragment;
    "ogasaToken()": FunctionFragment;
    ...
    "setMinAndMaxTicketPriceInOgasa(uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "maxPriceTicketInOgasa",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "minPriceTicketInOgasa",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "ogasaToken",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setMinAndMaxTicketPriceInOgasa",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "ogasaToken", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "operatorAddress",
    data: BytesLike
  ): Result;
...
export class OgasaSwapLottery extends BaseContract {
  ...
  interface: OgasaSwapLotteryInterface;
  ...
  functions: {
    ...
    maxPriceTicketInOgasa(overrides?: CallOverrides): Promise<[BigNumber]>;

    minPriceTicketInOgasa(overrides?: CallOverrides): Promise<[BigNumber]>;

    ogasaToken(overrides?: CallOverrides): Promise<[string]>;
    ...
    setMinAndMaxTicketPriceInOgasa(
      _minPriceTicketInOgasa: BigNumberish,
      _maxPriceTicketInOgasa: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    startLottery(
      ...
      _priceTicketInOgasa: BigNumberish,
      _discountDivisor: BigNumberish,
      _rewardsBreakdown: [
        BigNumberish,
        BigNumberish,
    ...
    viewLottery(
      ...
      [
        [
          ...
          firstTicketId: BigNumber;
          firstTicketIdNextLottery: BigNumber;
          amountCollectedInOgasa: BigNumber;
          finalNumber: number;
        }
      ]
    >;
  ...
  estimateGas: {
    ...
    ogasaToken(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    maxPriceTicketInOgasa(
      overrides?: CallOverrides
    ): Promise<PopulatedTransaction>;

    minPriceTicketInOgasa(
      overrides?: CallOverrides
    ): Promise<PopulatedTransaction>;

    ogasaToken(overrides?: CallOverrides): Promise<PopulatedTransaction>;
