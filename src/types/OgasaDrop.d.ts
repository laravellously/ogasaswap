...
export class OgasaDrop extends BaseContract {
  ...
  functions: {
    ...
    hasClaimed(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    hasClaimed(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    hasClaimed(overrides?: CallOverrides): Promise<PopulatedTransaction>;
