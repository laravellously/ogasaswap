...
interface IOgasaSwapLotteryInterface extends ethers.utils.Interface {
  functions: {
...
export class IOgasaSwapLottery extends BaseContract {
  ...
  interface: IOgasaSwapLotteryInterface;
